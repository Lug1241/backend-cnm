...
export class AsignacionController {
    ...
    async getAsignacionesPorDocente(@Param('id_docente', ParseIntPipe) idDocente: number) {
    ...
    async getAsignacionesPorPeriodo(@Param('periodo', ParseIntPipe) periodo: number) {
    ...
    async getAsignacionesPorAsignatura(
        ...
        return this.asignacionService.getByMateria(periodo, nivel as any, materia, jornada as any);
    }
